...
report_title = "Backend_api_dto"
report_des = 'test loginDTO. '
report_path = './report/'
report_file = report_path + 'backend_api_dto_report_01.html'
if not os.path.exists(report_path):
    os.mkdir(report_path)
else:
    pass
with open(report_file, 'wb') as report:
    suite.addTests(unittest.TestLoader().loadTestsFromName('test_case.test_tutorial_2.MyTestCase'))
